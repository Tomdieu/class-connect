...
import { useResourceStore } from '@/components/dashboard/admin/modals/ResourceModal'
...
function TopicDetailPage() {
  ...
  const { data, isError, error, isLoading } = useQuery({
    queryKey: ["class", id, "subjects", subjectId, "chapters", chapterId, "topics", topicId, "resources"],
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        ...
        <Button className="flex items-center gap-2" onClick={() => onAdd({ chapterId, classId: id, resourceType: "ExerciseResource", subjectId, topicId: topicId })}>
