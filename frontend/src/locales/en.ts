export default {
  ...
  "users.table.columns.userType": "User Type",
  ...
  "availability.subtitle": "Manage your teaching availability schedule",
  ...
  "registerDialog.classLoadError": "Failed to load classes. Please try again.",
  "registerDialog.classInformation": "Class Information",
  "registerDialog.professionalInformation": "Professional Information",
  "registerDialog.creatingAccount": "Creating Account...",
  "registerDialog.createAccount": "Create Account",
  "registerDialog.firstName": "First Name",
  "registerDialog.lastName": "Last Name",
  "registerDialog.firstNamePlaceholder": "Enter your first name",
  "registerDialog.lastNamePlaceholder": "Enter your last name",
  "registerDialog.passwordPlaceholder": "Enter your password",
  "registerDialog.confirmPasswordPlaceholder": "Confirm your password",
  "registerDialog.townPlaceholder": "Enter your town",
  "registerDialog.quarterPlaceholder": "Enter your quarter",
  "registerDialog.pickDate": "Pick a date",
  "registerDialog.email": "Email",
  "registerDialog.town": "Town",
  "registerDialog.quarter": "Quarter",
  "registerDialog.phoneNumber": "Phone Number",
  "registerDialog.dateOfBirth": "Date of Birth",
  "registerDialog.password": "Password",
  "registerDialog.confirmPassword": "Confirm Password",
  "registerDialog.selectSection": "Select a section",
  ...
  courseOfferings: {
    ...
    description: "Browse available course offerings",
    subject: "Subject",
    class: "Class",
    hourlyRate: "Hourly Rate",
    status: "Status",
    actions: {
      create: "Apply for this course",
    ...
    create: {
      ...
      description: "Create a new course offering for students",
      back: "Back to course offerings",
      offeringDetails: "Course Offering Details",
      offeringDetailsDescription: "Provide details about the course offering",
      classLevel: "Class Level",
      selectClass: "Select a class level",
      searchClass: "Search classes...",
      noClassFound: "No class found",
      classLevelDescription: "The class level for this course offering",
      subject: "Subject",
      selectSubject: "Select a subject",
      searchSubject: "Search subjects...",
      noSubjectFound: "No subject found",
      subjectDescription: "The subject for this course offering",
      student: "Student",
      selectStudent: "Select a student",
      studentNotFound: "Student not found",
      searchStudent: "Search students...",
      noStudentFound: "No student found",
      studentDescription: "The student taking this course",
      studentAvailability: "Student Availability",
      startDate: "Start Date",
      pickDate: "Pick a date",
      startDateDescription: "When the course will start",
      duration: "Duration (per session)",
      hour: "hour",
      hours: "hours",
      durationDescription: "How long each session will last",
      frequency: "Weekly Frequency",
      frequencyDescription: "How many times per week the course will be held",
      hourlyRate: "Hourly Rate (XAF)",
      hourlyRateDescription: "The cost per hour for this course",
      cancel: "Cancel",
    ...
    edit: {
      ...
      description: "Modify the details of this course offering",
      back: "Back",
      offeringDetails: "Course Offering Details",
