  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 md:py-24 relative z-10">
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
            ...
            >
              <span className="px-4 py-2 rounded-full bg-primary/10 text-primary font-semibold text-sm inline-block mb-4">
                {locale === 'fr' ? 'La Plateforme E-learning N°1 au Cameroun' : '#1 E-learning Platform in Cameroon'}
              </span>
            </motion.div>
            ...
            >
              <Link href="/auth/register">
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <Button size="lg" className="bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20 font-semibold px-8 py-6 rounded-xl">
              ...
              <Link href="#features">
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <Button size="lg" variant="outline" className="border-primary/20 text-primary hover:bg-primary/5 font-semibold px-8 py-6 rounded-xl">
                    {t("hero.learnMore")}
                  </Button>
                </motion.div>
              </Link>
            ...
            >
              <div className="flex items-center gap-1">
                ...
                <span>
                  <strong className="font-semibold text-gray-700">4.9/5</strong> {locale === 'fr' ? 'Satisfaction des étudiants' : 'Student satisfaction'}
                </span>
              </div>
              
              <div className="flex items-center gap-1">
                <svg viewBox="0 0 24 24" className="h-5 w-5 text-primary" stroke="currentColor" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
                  <polyline points="22 4 12 14.01 9 11.01" />
                </svg>
                <span>
                  <strong className="font-semibold text-gray-700">5000+</strong> {locale === 'fr' ? 'Étudiants actifs' : 'Active students'}
                </span>
              </div>
              
              <div className="flex items-center gap-1">
                <svg viewBox="0 0 24 24" className="h-5 w-5 text-green-500" stroke="currentColor" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </svg>
                <span>
                  <strong className="font-semibold text-gray-700">100%</strong> {locale === 'fr' ? 'Paiement sécurisé' : 'Secure payments'}
                </span>
              </div>
            </motion.div>
          </div>
            ...
            <div className="relative aspect-[4/3] w-full max-w-lg mx-auto">
                ...
                <div className="relative w-full h-full rounded-xl overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center">
                  <Image
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = "https://placehold.co/600x450/e2e8f0/64748b?text=ClassConnect";
                    }}
                  />
              ...
              >
                ...
                <div className="text-sm">
                  <p className="font-semibold text-gray-900">{locale === 'fr' ? 'Apprentissage interactif' : 'Interactive learning'}</p>
                  <p className="text-gray-500 text-xs">{locale === 'fr' ? 'Engageant et efficace' : 'Engaging & effective'}</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="text-sm">
                  <p className="font-semibold text-gray-900">{locale === 'fr' ? 'Support 24/7' : '24/7 Support'}</p>
                  <p className="text-gray-500 text-xs">{locale === 'fr' ? 'Toujours là pour vous' : 'Always there for you'}</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
        ...
        >
          <p className="text-sm font-medium text-gray-500 mb-6">{locale === 'fr' ? 'UTILISÉ AVEC CONFIANCE PAR' : 'TRUSTED BY'}</p>
          <div className="flex flex-wrap justify-center gap-x-12 gap-y-8">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-8 w-auto opacity-50 hover:opacity-100 transition-opacity duration-200">
