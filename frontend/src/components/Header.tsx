    ...
    return (
        <div className={cn('flex items-center justify-between py-5',className)}>
            <Link href={"/"} className='select-none flex items-center gap-1 cursor-pointer text-blue-600'>
                ...
                <h1 className='font-black text-base sm:text-lg text-blue-600'>ClassConnect</h1>
            </Link>
            <div className='flex items-center gap-1 2xl:gap-5'>
                <Button variant={"outline"} size={isMobile ? "default" : "default"} onClick={openLogin} className='text-black hover:text-blue-600 hover:bg-primary/10 border'>
