        ...
        headers: [
          {
            ...
            value: [
              ...
              "script-src-elem 'self' 'unsafe-inline' https://analytics.ahrefs.com",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: blob: https:",
              "media-src 'self' blob: https://s3.us-east-005.backblazeb2.com https://*.backblazeb2.com data:",
              "object-src 'none'",
              "font-src 'self'",
              "connect-src 'self' https://analytics.ahrefs.com https://s3.us-east-005.backblazeb2.com https://*.backblazeb2.com https: ws: wss:",
              "frame-src 'self'",
